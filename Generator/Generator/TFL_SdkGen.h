...
#include "SF2/GameDefines.h"
#include "SF2/ObjectFunctions.h"
#include "SF2/PiecesOfCode.h"
...
#define SDK_GEN_CREDITS			"uNrEaL, Tamimego, SystemFiles, R00T88, _silencer, the1domo, K@N@VEL, Vynx (A51)"
