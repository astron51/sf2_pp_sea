...
// Info
#define GAME_NAME				"Special Force2"
#define GAME_NAME_S				"SF2"
#define GAME_VERSION			"1.0.1297.0"

// Game
#define CLASS_ALIGN				0x4

// ProcessEvent Sig				//74 ?? 83 C0 07 83 E0 F8 E8 ?? ?? ?? ?? 8B C4
...
// UE3 Tables Sigs				//A1 ?? ?? ?? ?? 8B ?? ?? 8B ?? ?? 25 00 02 00 00
...
*/
	...
	public:
		...
		FName										       FriendlyName;                                             // 0x0098 (0x04) 
		unsigned char                                      NumParms;                                                 // 0x00A0 (0x02)
		unsigned short                                     ParmsSize;                                                // 0x00A2 (0x02)
		unsigned short                                     ReturnValueOffset;                                        // 0x00A4 (0x04) 
		char							                   UnknownData00[ 0x4 ];									 // 0x00A8 (0x04) 
	...
	{
	public:
		unsigned char			UnknownData00[ 0xF8 ];					// 0x00D8 (0x00F8)
	...
	public:
		...
		struct FQWord		PropertyFlags;								// 0x004C (0x08)
		unsigned long		PropertySize;								// 0x0050 (0x04)
